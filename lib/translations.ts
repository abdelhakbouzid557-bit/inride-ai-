...
const ar: Dict = {
  ...
  hero: {
    badge: "حرية التفاوض والتنقّل بأسعار عادلة",
    titleA: "مستعد للانطلاق",
    titleB: "مع INRIDE AI؟",
    subtitle:
      "حمّل التطبيق وابدأ رحلتك الأولى — مجاناً وبأسعار تتفاوض عليها بنفسك.",
    ctaPwa: "حمّل التطبيق الآن",
...
const fr: Dict = {
  ...
  hero: {
    ...
    titleA: "Prêt à démarrer",
    titleB: "avec INRIDE AI ?",
    subtitle:
      "Téléchargez l'application et commencez votre premier trajet — gratuitement et à un prix que vous négociez vous-même.",
    ctaPwa: "Télécharger l'appli",
...
const en: Dict = {
  ...
  hero: {
    ...
    titleA: "Ready to ride",
    titleB: "with INRIDE AI?",
    subtitle:
      "Download the app and start your first trip — free and at prices you negotiate yourself.",
    ctaPwa: "Download the app",
